import { FaArrowUp, FaArrowDown, FaSearch, FaEllipsisV, FaCheck, FaTimes, FaQuestion } from "react-icons/fa";
...
const SampleSecondPage = () => {
  return (
    <div className="flex min-h-screen">
        <Sidebar />
        <div className="flex-1 flex flex-col">
            <Topbar pageTitle="Sample Second Page" />
                    ...
                    columns={[
                      ...
                      { header: "Business Name", accessor: "business" },
                      {
                        ...
                        render: (row) => (
                          ...
                          //   {row.License_ver === true ? (
                          //       <FaCheck className="text-green-500 text-lg" />
                          //     ) : adv.License_ver === false ? (
...
export default SampleSecondPage;
